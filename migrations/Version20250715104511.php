 ...
 */
final class Version20250715104511 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id SERIAL NOT NULL, author_id INT NOT NULL, task_id INT NOT NULL, text TEXT NOT NULL, PRIMARY KEY(id))');
